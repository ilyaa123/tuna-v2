...
export const Search:FC = () => {
    ...
    return (
        <form className={style.Search} onSubmit={handleOnSubmit}>
            ...
            <Input className={style.Search__input} onChange={handleOnChange} value={value} placeholder="Введите проффесию"/>
            <Button className={style.Search__button} onClick={handleOnClick} text="Поиск" padding="9px 36px" />
        </form>
    )
}